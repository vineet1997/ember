"""Local-only timeout path: retain the committed scene and offer recovery."""
...
with sync_playwright() as p:
    ...
    page.wait_for_function("window.FILM.pending === null && window.FILM.staging === null", timeout=30000)
    result = page.evaluate("""() => ({active:window.FILM.active, title:document.querySelector('#title').textContent,
      iframeCount:document.querySelectorAll('iframe').length, bridge:document.querySelector('#bridge').textContent,
